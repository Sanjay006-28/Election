...
const respondToCalendar = () => ({
  message:
    "Use the Add to Google Calendar button in the booth panel to create an Election Day reminder. It opens a real Google Calendar template in a new tab without requiring an API key.",
  suggestions: [
